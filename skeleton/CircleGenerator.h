...
public:
	...
	CircleGenerator(Vector3 mean_pos, double numParticles, double radio_,
		double generation_probability_, Particle* p , int tipo, typeForce type = GravityForce, double k1 = 0.5, double k2 = 0, double K = -3, Vector3 gravity = { 0,-9.8,0 }
	, Vector3 windVel = { 0,0,20 }, Vector3 whirlPos = { 80, 50, -200 });
	~CircleGenerator();
